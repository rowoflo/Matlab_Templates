...
% assert(isa(class_nameObj,'package_name.class_name') && numel(class_nameObj) == 1,...
%     'package_name:class_name:method_name:class_nameObj',...
%     'Input argument "class_nameObj" must be a 1 x 1 "package_name.class_name" object.')
%
